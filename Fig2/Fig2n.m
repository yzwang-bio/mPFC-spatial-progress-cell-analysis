...
e=errorbar([x1(1),x1(2)],[mpub_pcell_pct(1),mpub_pcell_pct_shuffle(1)],[sepub_pcell_pct(1),sepub_pcell_pct_shuffle(1)],'.');e.Visible='off';
e=errorbar([x2(1),x2(2)],[mpub_pcell_pct(2),mpub_pcell_pct_shuffle(2)],[sepub_pcell_pct(2),sepub_pcell_pct_shuffle(2)],'.');e.Visible='off';
