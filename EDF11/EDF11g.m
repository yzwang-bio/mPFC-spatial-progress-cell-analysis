%% Code for Extended Data Fig. 11g
...
%%
load('EDF11/umap_inactivateHPCtoPFC.mat')
...
figure
hold on;
scatter(0.5,Intra_Inter_Prog_Dist_ratio_dir2(:,1),scatter_point_size,color_saline,'filled','LineWidth',scatter_point_linewidth);
scatter(1.5,Intra_Inter_Prog_Dist_ratio_dir2(:,2),scatter_point_size,color_cno,'filled','LineWidth',scatter_point_linewidth);
e1=errorbar([0.5,1.5],[mIntra_Inter_Prog_Dist_ratio_dir2(:,1),mIntra_Inter_Prog_Dist_ratio_dir2(:,2)],[seIntra_Inter_Prog_Dist_ratio_dir2(:,1),seIntra_Inter_Prog_Dist_ratio_dir2(:,2)]);e1.Color='k';e1.LineWidth=errorbar_width;e1.CapSize=18;
for ani=1:nAnimals
