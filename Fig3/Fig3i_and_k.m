...
scatter(1+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_dir1(:,1),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');scatter(2+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_dir1(:,2),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');
...
scatter(1+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_dir2(:,1),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');scatter(2+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_dir2(:,2),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');
...
scatter(1+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_model2_dir1(:,1),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');scatter(2+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_model2_dir1(:,2),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');
...
scatter(1+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_model2_dir2(:,1),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');scatter(2+(-0.25 + 0.5 * rand(nAnimals, 1)),decoding_error_model2_dir2(:,2),30,[0.8,0.8,0.8],'filled','LineWidth',scatter_point_linewidth,'MarkerEdgeColor','none');
