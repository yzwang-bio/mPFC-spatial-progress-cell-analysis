...
for i = 1:2
    eval(sprintf('e%s=errorbar(x%s, mpathselectRate%s, sepathselectRate%s, ''linestyle'', ''none'');e%s.Color=errorbar_color;e%s.LineWidth=errorbar_width;',num2str(i),num2str(i),num2str(i),num2str(i),num2str(i),num2str(i)))
end
