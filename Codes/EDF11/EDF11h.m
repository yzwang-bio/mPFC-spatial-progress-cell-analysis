%% Code for Extended Data Fig. 11h
...
%%
load('EDF11/progress_decoding_inactivateHPCtoPFC.mat')
...
figure
hold on;
scatter(1,decoding_error_dir2(:,1),scatter_point_size,color_saline,'filled','LineWidth',scatter_point_linewidth);
scatter(2,decoding_error_dir2(:,2),scatter_point_size,color_cno,'filled','LineWidth',scatter_point_linewidth);
e1=errorbar([1,2],[mdecoding_error_dir2(:,1),mdecoding_error_dir2(:,2)],[sedecoding_error_dir2(:,1),sedecoding_error_dir2(:,2)]);e1.Color='k';e1.LineWidth=errorbar_width;e1.CapSize=18;
% for ani=1:nAnimals
%     plot([1,2],[decoding_error_dir2(ani,1),decoding_error_dir2(ani,2)],'Color',[0.8,0.8,0.8])
% end
